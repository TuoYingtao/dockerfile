USE sys;
DELIMITER // CREATE PROCEDURE InitDatabaseAndUser(OUT SUCCESS BOOLEAN, OUT ERROR_MESSAGE TEXT) BEGIN
    ...
    -- 创建访问用户
    SET @CREATE_USER = CONCAT('CREATE USER ', @DATABASE_USER_NAME, '@\'%\' IDENTIFIED BY \'123456\'');
...
DELIMITER // CREATE PROCEDURE RunInitAndCleanup() BEGIN
